...
menl log_volume = {U[patient_n]} + {k0} + log({v0} / {k0}) * exp(-{a1} / {l0} * follow_up_months + ///
	{b1} * initial_volume + {b2} * current_age_years + {b3} * gender_bin) ///
	+ {b4} * spacing3 + {b5} * multifocality + {b6} * t2 + {b7} * oedema ///
	+ {b8} * t2, ///
